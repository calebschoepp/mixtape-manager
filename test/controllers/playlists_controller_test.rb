...
class PlaylistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create playlist" do
    assert_difference("Playlist.count") do
      post playlists_url, params: { playlist: { description: @playlist.description, name: @playlist.name } }
    end
  ...
  test "should update playlist" do
    patch playlist_url(@playlist), params: { playlist: { description: @playlist.description, name: @playlist.name } }
